...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-lg border-b">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 h-16">
          <div className="flex items-center gap-2.5">
            <img src={stokivoLogo} alt="Stokivo" className="h-9 w-9" />
            <div>
              <span className="font-display font-bold text-xl text-foreground">Stokivo</span>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground">
            ...
            <a href="#testimonial" className="hover:text-foreground transition-colors">Testimonials</a>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              <Link to="/register">
                <Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-full px-8 h-12 font-semibold gap-2">
      ...
      {/* Features bar */}
      <section id="features" className="bg-primary text-primary-foreground py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            {features.map((f) => (
              <div key={f.title} className="text-center space-y-3">
                <div className="h-14 w-14 mx-auto rounded-2xl bg-primary-foreground/10 flex items-center justify-center">
      ...
      <section id="testimonial" className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* Testimonial */}
          <div className="rounded-2xl bg-muted/50 border p-8 flex flex-col justify-between">
            <div>
          ...
          {/* CTA */}
          <div className="rounded-2xl bg-primary text-primary-foreground p-8 flex flex-col justify-between">
            <div>
            ...
            <div className="mt-6">
              <Link to="/register">
                <Button size="lg" variant="secondary" className="w-full rounded-full font-semibold h-12">
      ...
      {/* Multi-channel */}
      <section id="channels" className="bg-muted/30 border-y py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-display font-bold text-foreground">Sell Everywhere. Manage in One Place.</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-10">
            {channels.map((ch) => (
              <div key={ch.name} className="flex items-center gap-2 rounded-full bg-card border px-5 py-2.5 text-sm font-medium text-foreground shadow-sm">
